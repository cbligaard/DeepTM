...
Inline-style: 
![Model setup. Red boxes represent the layers of the neural network, while the grey boxes represent functions used to derive the actual predictions.](https://github.com/cbligaard/DeepTM/master/images/model.png)
